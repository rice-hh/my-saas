package com.my.saas.common.constants;
...
public class DateConstants {
    ...
    public static final String DATE_MODEL_19 = "HH:mm";
    ...
    public static String getType(String date) {
        ...
        if (date.matches("\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}.\\d+")) {
            result = DateConstants.DATE_MODEL_1;
        } else if (date.matches("\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}")) {
            result = DateConstants.DATE_MODEL_2;
        } else if (date.matches("\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}")) {
            result = DateConstants.DATE_MODEL_3;
        } else if (date.matches("\\d{4}-\\d{2}-\\d{2} \\d{2}")) {
            result = DateConstants.DATE_MODEL_4;
        } else if (date.matches("\\d{4}-\\d{2}-\\d{2}")) {
            result = DateConstants.DATE_MODEL_5;
        } else if (date.matches("\\d{4}-\\d{2}")) {
            result = DateConstants.DATE_MODEL_6;
        } else if (date.matches("\\d{14}.\\d+")) {
            result = DateConstants.DATE_MODEL_7;
        } else if (date.matches("\\d{14}")) {
            result = DateConstants.DATE_MODEL_8;
        } else if (date.matches("\\d{12}")) {
            result = DateConstants.DATE_MODEL_9;
        } else if (date.matches("\\d{10}")) {
            result = DateConstants.DATE_MODEL_10;
        } else if (date.matches("\\d{8}")) {
            result = DateConstants.DATE_MODEL_11;
        } else if (date.matches("\\d{6}")) {
            result = DateConstants.DATE_MODEL_12;
        } else if (date.matches("\\d{4}/\\d{2}/\\d{2} \\d{2}:\\d{2}:\\d{2}.\\d+")) {
            result = DateConstants.DATE_MODEL_13;
        } else if (date.matches("\\d{4}/\\d{2}/\\d{2} \\d{2}:\\d{2}:\\d{2}")) {
            result = DateConstants.DATE_MODEL_14;
        } else if (date.matches("\\d{4}/\\d{2}/\\d{2} \\d{2}:\\d{2}")) {
            result = DateConstants.DATE_MODEL_15;
        } else if (date.matches("\\d{4}/\\d{2}/\\d{2} \\d{2}")) {
            result = DateConstants.DATE_MODEL_16;
        } else if (date.matches("\\d{4}/\\d{2}/\\d{2}")) {
            result = DateConstants.DATE_MODEL_17;
        } else if (date.matches("\\d{4}/\\d{2}")) {
            result = DateConstants.DATE_MODEL_18;
        }
        return result;
    }
}
